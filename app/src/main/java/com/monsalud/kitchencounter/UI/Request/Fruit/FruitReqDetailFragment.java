...
public class FruitReqDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fruit_req_detail, container, false);
        mTvFruitName = (TextView) view.findViewById(R.id.tvFruitName_reqfruitdetail);
        mTvFruitVarietalName = (TextView) view.findViewById(R.id.tvFruitVarietalName_reqfruitdetail);
        mTvEmployeeName = (TextView) view.findViewById(R.id.tvEmployeeName_reqfruitdetail);
        mTvUnit = (TextView) view.findViewById(R.id.tvUnit_reqfruitdetail);
        mTvProductID = (TextView) view.findViewById(R.id.tvProductId_reqfruitdetail);
        mBtnAddToRequests = (Button) view.findViewById(R.id.btnADDTOREQUESTS_reqfruitdetail);
        mBtnAddToRequests.setOnClickListener(buttonAddRequestsListener);

        mEtAmount = (EditText) view.findViewById(R.id.etAmount_reqfruitdetail);
...
//        };
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof FruitReqDetailFragment.OnAddToRequestsListener) {
            mOnAddToRequestsListener = (FruitReqDetailFragment.OnAddToRequestsListener) context;
        } else {
