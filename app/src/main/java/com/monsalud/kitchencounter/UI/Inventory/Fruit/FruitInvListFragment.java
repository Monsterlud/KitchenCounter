...
public class FruitInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFruitRecyclerAdapter = new FruitRecyclerAdapter(getContext(), FruitInvActivity.mFruits);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fruit_inv_list, container, false);
        ...
        recyclerFruits.setAdapter(new FruitRecyclerAdapter(getContext(), FruitInvActivity.mFruits));
