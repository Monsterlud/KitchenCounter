...
public class BeverageInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBeverageRecyclerAdapter = new BeverageRecyclerAdapter(getContext(), BeverageInvActivity.mBeverages);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_beverage_inv_list, container, false);
        ...
        recyclerBeverages.setAdapter(new BeverageRecyclerAdapter(getContext(), BeverageInvActivity.mBeverages));
        return view;
    }
    @Override
