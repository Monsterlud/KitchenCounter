...
public class VegetableInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVegetableRecyclerAdapter = new VegetableRecyclerAdapter(getContext(), VegetableInvActivity.mVegetables);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_vegetable_inv_list, container, false);
        ...
        recyclerVeggies.setAdapter(mVegetableRecyclerAdapter);
