...
public class SeafoodInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSeafoodRecyclerAdapter = new SeafoodRecyclerAdapter(getContext(), SeafoodInvActivity.mSeafoods);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_seafood_inv_list, container, false);
        ...
        recyclerSeafood.setAdapter(new SeafoodRecyclerAdapter(getContext(), SeafoodInvActivity.mSeafoods));
