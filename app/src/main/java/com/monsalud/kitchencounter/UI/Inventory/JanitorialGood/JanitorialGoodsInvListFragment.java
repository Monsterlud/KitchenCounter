...
public class JanitorialGoodsInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mJanitorialGoodRecyclerAdapter = new JanitorialGoodRecyclerAdapter(getContext(), JanitorialGoodsInvActivity.mJanitorialGoods);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_janitorial_goods_inv_list, container, false);
        ...
        recyclerJanitorialGoods.setAdapter(new JanitorialGoodRecyclerAdapter(getContext(), JanitorialGoodsInvActivity.mJanitorialGoods));
        return view;
    }
    @Override
