...
public class DairyInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDairyRecyclerAdapter = new DairyRecyclerAdapter(getContext(), DairyInvActivity.mDairies);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dairy_inv_list, container, false);
        ...
        recyclerDairy.setAdapter(new DairyRecyclerAdapter(getContext(), DairyInvActivity.mDairies));
