...
public class MeatInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMeatRecyclerAdapter = new MeatRecyclerAdapter(getContext(), MeatInvActivity.mMeats);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_meat_inv_list, container, false);
        ...
        recyclerMeats.setAdapter(new MeatRecyclerAdapter(getContext(), MeatInvActivity.mMeats));
