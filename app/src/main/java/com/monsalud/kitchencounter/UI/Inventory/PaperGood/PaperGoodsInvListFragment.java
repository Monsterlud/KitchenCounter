...
public class PaperGoodsInvListFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPaperGoodRecyclerAdapter = new PaperGoodRecyclerAdapter(getContext(), PaperGoodsInvActivity.mPaperGoods);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_paper_goods_inv_list, container, false);
        ...
        recyclerPaperGoods.setAdapter(new PaperGoodRecyclerAdapter(getContext(), PaperGoodsInvActivity.mPaperGoods));
        return view;
    }
    @Override
